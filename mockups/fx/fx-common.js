// Shared canvas plumbing for the hero effects: sizing, pointer tracking, theme colors.
// Each effect calls FX.start({ init, resize, frame }) and draws with the `state` it receives.
(function () {
  ...
  window.FX = { start, seededRandom, gaussian, mono: '11px "JetBrains Mono", ui-monospace, monospace' };
})();
